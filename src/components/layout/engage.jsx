...
const Engage = () => {
  return (
    <div className="container px-12 py-28">
        <Card className="bg-purple-800 text-white text-center flex flex-col items-center justify-center space-y-6 p-12 max-md:p-4 relative rounded-2xl overflow-hidden">
            ...
            <Button className="bg-yellow-600 z-20 text-lg max-md:text-base rounded-full p-7">
