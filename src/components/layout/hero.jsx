  ...
  return (
    <div>
      <MaxWidthWrapper className='max-lg:mx-auto'>
          <div className="max-md:mx-auto relative overflow-hidden rounded-xl border md:rounded-lg max-md:h-[60svh] h-[80svh]">
            <img
            ...
            />
              ...
              <h1 className="text-6xl max-md:text-4xl font-bold px-4 max-md:px-0">Tailored Corporate Wellness Programs🤑</h1>
              <p className="text-lg font-semibold">Elevate Your Employees Well-Being</p>
